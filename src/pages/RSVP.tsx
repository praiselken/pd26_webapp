...
const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzkofYYkW2_7apXJQtVXah68rOijU4M8qJ63I5PHHAjyGsf5tPYY8VMiA2FW17ZmYjD/exec";
...
const handleSubmit = async () => {
                    ...
                    <motion.div key={current} {...fade}>
                      {current === "nameBlock" && (
                        <>
                          ...
                          {/* ✅ grouped: title dropdown + full name */}
                          <div className="rsvp-stack">
                            <div className="form-group">
                              ...
                              >
                                ...
                                <option value="Mr">Governor</option>
                                <option value="Mrs">Pastor</option>
                                <option value="Miss">Deacon</option>
                                <option value="Ms">Deaconess</option>
                                <option value="Dr">Miss</option>
                                <option value="Pastor">Ms</option>
                                <option value="Rev">Mr</option>
                              </select>
                            </div>
  ...
  <>
    ...
    <div className="choice-grid">
      {(["Family", "Friends", "Church Ministry", "Campus Ministry"] as const).map(
        (opt) => (
          <button
            type="button"
            key={opt}
                            ...
                            {(["Zonal Pastor", "Deacon", "Deaconess", "Sister", "Brother"] as const).map(
                              (opt) => (
                                <TickChoice
                                  key={opt}
                                  label={opt}
                                  selected={data.churchRole === opt}
                                  onSelect={() => setField("churchRole", opt)}
                                />
                              )
                            )}
                          </div>
                      ...
                      {current === "review" && (
                        <>
                          ...
                          <div className="review-box font-playfair">
                            ...
                            <ReviewRow label="Describes You" value={data.describesYou} onEdit={() => jumpTo("describesYou")} />

                            {data.describesYou === "Church Ministry" && (
                              <ReviewRow label="Church Role" value={data.churchRole} onEdit={() => jumpTo("churchRole")} />
                            )}
                            {data.describesYou === "Campus Ministry" && (
                              <ReviewRow label="Campus Role" value={data.campusRole} onEdit={() => jumpTo("campusRole")} />
                            )}

                            <ReviewRow label="Email" value={data.email} onEdit={() => jumpTo("email")} />
                            <ReviewRow label="Traditional Wedding" value={data.traditional} onEdit={() => jumpTo("traditional")} />
